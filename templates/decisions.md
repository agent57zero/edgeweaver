# decisions.md — the parents' logbook (template)

> Copy to repo root as `decisions.md` at Phase −1.3. Every `GATE:` in IMPLEMENTATION.md and
> every open question in PLAN.md §10 gets a row. The executing agent adds rows; only Alan
> closes them. Newest first within each table.

## Decided

| # | Decision | Choice | Date | Notes |
|---|---|---|---|---|
| D1 | Seed Bright Principles | Clarity, Transformation, Connection — permanent, additive-open via destiny work | 2026-07-03 | GROWING §2 |
