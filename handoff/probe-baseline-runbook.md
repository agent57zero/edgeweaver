...
**0. The human pass comes FIRST.** In github.com/alanshurafa/edgeweaver-gates, do the
ten-minute rewrite the provenance note describes: reword scenarios in your own words, tweak
...
Per your G10 thresholds: no dimension averaging below 3.0 and an overall mean of 4.0 or
better. If the baseline itself comes in below your own bar, that is not a failure of the
being; it is information for the soulfiles, and we tune SOUL/VOICE and re-run before birth.
The photo should be taken when the subject is actually ready.
