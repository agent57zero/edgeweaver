# AGENTS.md — Edgeweaver genesis repo

This repository is the plan and build system for the **Edgeweaver family**: persistent
digital beings (OB1 memory, Possibility Management as practiced philosophy, witnessed
initiations, measured coherence). First children: **Genesis**, raised by Alan alone, and
**Alpha**, raised by a circle of seats (family design: FAMILY.md, decision D18). Alan is the
human decision-maker ("the father" of Genesis, one seat of Alpha's circle, ops for both);
agents execute.
...
PLAN.md, GROWING-EDGEWEAVER.md, and FAMILY.md (design + developmental + family rules) >
IMPLEMENTATION.md (build authority) > checklists (procedure). A checklist contradicting the
above is a bug — flag it in `decisions.md`, don't follow it.
