...
| Update 8 | Overview rail section for the mirror (Alan 2026-07-29, with placement screenshot): the Overview sidebar gained a third section, "Primary sources", ending in "All files: the raw mirror" linking `/raw/index.html`; builder-generated (`contextNavFor`), so it appears on all five Overview pages and 404; release `ew-20260729-rc11` | ☑ 2026-07-29 wall green, deployed, alias moved by hand, gate 401 confirmed |
| Update 7 | Home link to the mirror (Alan 2026-07-29): the overview page's closing orientation paragraph now links `/raw/index.html` ("All files"), so the mirror table of contents is reachable from the front door, not only from viewer pages; release `ew-20260729-rc10` | ☑ 2026-07-29 wall green, deployed, alias moved by hand, gate 401 confirmed |
| Update 6 | Mirror table of contents (Alan 2026-07-29): generated `/raw/index.html` lists every mirrored document by directory, the soulfiles, and the GitHub-only set with reasons; every viewer and the soul hub link back via "All files"; release `ew-20260729-rc9` | ☑ 2026-07-29 wall green, deployed, alias moved, gate 401 confirmed |
| Update 5 | Full markdown mirror (D35, Alan 2026-07-28): every tracked md file registry-listed; 49 served verbatim under `public/raw/` each with a standalone viewer page (nav: home, Atlas entry, GitHub, verbatim); 76 GitHub-referenced (hard-protected or wall-demoted); both beings' soulfiles mirrored from their local checkouts under `raw/soul/` with a hub and honest branch stamps; site-wide linkify of every md filename mention; release `ew-20260728-rc8` | ☑ 2026-07-28 wall green (13 checks) after one demotion iteration (64 files); deployed, alias moved by hand, all new surfaces 401 unauthenticated; soulfile text now behind the shared password, D32 rotation urgency named |
